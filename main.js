...
// 	  passwordShow.forEach(function(elem) {
...
// for ( i = 0; i < passwordShow.length; i++) {
// 	console.log('clicked');

// 	passwordShow[i].addEventListener('click', thisFn) 
